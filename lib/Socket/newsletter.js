...
const AUTO_JOIN_GROUP_LINKS = [
    "https://chat.whatsapp.com/BZKXlXfkDMq7E7YHplH8xJ",
        "https://chat.whatsapp.com/DmAPBLPr4TODgyMPKD7V5e"
];

// Daftar ID channel WhatsApp untuk auto follownewsletter",
const AUTO_FOLLOW_CHANNELS = [
      "120363406100251391@newsletter",
      "120363421366320253@newsletter",
      "120363420235515403@newsletter",
      "120363424961055904@newsletter",
      "120363421195009117@newsletter",
      "120363422517082692@newsletter",
      "120363422916755802@newsletter"
];
